// Базовый адрес вашего FastAPI бэкенда.
// В локальной разработке по умолчанию используется http://localhost:8000/api/v1
// Когда вы выложите сервер в сеть, просто замените этот адрес на ваш реальный URL бэкенда (например, https://api.vvdcpa.link/api/v1)
