...
const OFFERS_DETAILS_MAP: Record<string, DetailData> = {
  ...
  hold: 'Без холда',
  payout: '$0.10 - $50',
  description: 'Офферы Web Cam с международным трафиком и различными моделями конверсий.',
  allowedTraffic: ['Social Media', 'Native Ads', 'Popunder'],
  forbiddenTraffic: ['Incentive Traffic', 'Fraud / Bot', 'Motivated traffic'],
  smartlinkSuffix: 'wc540',
},
  'adult-games': {
    title: 'Adult Games',
    geo: 'Worldwide',
    hold: 'Без холда',
    payout: '$0.10 - $50',
    description: 'Adult Games офферы с международным трафиком и различными моделями конверсий.',
    allowedTraffic: ['Social Media', 'Native Ads', 'Popunder'],
    forbiddenTraffic: ['Incentive Traffic', 'Fraud / Bot', 'Motivated traffic'],
    smartlinkSuffix: 'ag901',
},
  'gaming': {
    title: 'Gaming',
    geo: 'Worldwide',
